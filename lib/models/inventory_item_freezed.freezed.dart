...
mixin _$InventoryItem {
 ...
 int get currentStock; int get maxStock; int get minStock; String get unit; String? get description; String? get imageUrl;@ISODateTimeConverter() DateTime get createdAt;@ISODateTimeConverter() DateTime get updatedAt;
...
@useResult
$Res call({
 String id, String name, String category, int currentStock, int maxStock, int minStock, String unit, String? description, String? imageUrl,@ISODateTimeConverter() DateTime createdAt,@ISODateTimeConverter() DateTime updatedAt
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String category,  int currentStock,  int maxStock,  int minStock,  String unit,  String? description,  String? imageUrl, @ISODateTimeConverter()  DateTime createdAt, @ISODateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _InventoryItem():
return $default(_that.id,_that.name,_that.category,_that.currentStock,_that.maxStock,_that.minStock,_that.unit,_that.description,_that.imageUrl,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
class _InventoryItem extends InventoryItem {
  const _InventoryItem({required this.id, required this.name, required this.category, required this.currentStock, required this.maxStock, required this.minStock, required this.unit, this.description, this.imageUrl, @ISODateTimeConverter() required this.createdAt, @ISODateTimeConverter() required this.updatedAt}): super._();
...
mixin _$StockRequest {
 ...
 String get id; String get itemId; String get itemName; String get requesterId; String get requesterName; int get requestedQuantity; String? get notes; StockRequestStatus get status;@ISODateTimeConverter() DateTime get requestedAt;@NullableISODateTimeConverter() DateTime? get approvedAt; String? get approvedBy; String? get approvedByName; String? get rejectionReason;
...
@useResult
$Res call({
 String id, String itemId, String itemName, String requesterId, String requesterName, int requestedQuantity, String? notes, StockRequestStatus status,@ISODateTimeConverter() DateTime requestedAt,@NullableISODateTimeConverter() DateTime? approvedAt, String? approvedBy, String? approvedByName, String? rejectionReason
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String itemId,  String itemName,  String requesterId,  String requesterName,  int requestedQuantity,  String? notes,  StockRequestStatus status, @ISODateTimeConverter()  DateTime requestedAt, @NullableISODateTimeConverter()  DateTime? approvedAt,  String? approvedBy,  String? approvedByName,  String? rejectionReason)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StockRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String itemId,  String itemName,  String requesterId,  String requesterName,  int requestedQuantity,  String? notes,  StockRequestStatus status, @ISODateTimeConverter()  DateTime requestedAt, @NullableISODateTimeConverter()  DateTime? approvedAt,  String? approvedBy,  String? approvedByName,  String? rejectionReason)  $default,) {final _that = this;
switch (_that) {
case _StockRequest():
return $default(_that.id,_that.itemId,_that.itemName,_that.requesterId,_that.requesterName,_that.requestedQuantity,_that.notes,_that.status,_that.requestedAt,_that.approvedAt,_that.approvedBy,_that.approvedByName,_that.rejectionReason);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String itemId,  String itemName,  String requesterId,  String requesterName,  int requestedQuantity,  String? notes,  StockRequestStatus status, @ISODateTimeConverter()  DateTime requestedAt, @NullableISODateTimeConverter()  DateTime? approvedAt,  String? approvedBy,  String? approvedByName,  String? rejectionReason)?  $default,) {final _that = this;
switch (_that) {
case _StockRequest() when $default != null:
return $default(_that.id,_that.itemId,_that.itemName,_that.requesterId,_that.requesterName,_that.requestedQuantity,_that.notes,_that.status,_that.requestedAt,_that.approvedAt,_that.approvedBy,_that.approvedByName,_that.rejectionReason);case _:
  return null;
...
class _StockRequest extends StockRequest {
  const _StockRequest({required this.id, required this.itemId, required this.itemName, required this.requesterId, required this.requesterName, required this.requestedQuantity, this.notes, required this.status, @ISODateTimeConverter() required this.requestedAt, @NullableISODateTimeConverter() this.approvedAt, this.approvedBy, this.approvedByName, this.rejectionReason}): super._();
...
@override@ISODateTimeConverter() final  DateTime requestedAt;
