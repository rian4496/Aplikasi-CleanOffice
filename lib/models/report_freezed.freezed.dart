...
// Required fields
 String get id; String get title; String get location;@TimestampConverter() DateTime get date; ReportStatus get status; String get userId; String get userName;// Employee info (optional)
 String? get userEmail;// Cleaner info (optional)
 String? get cleanerId; String? get cleanerName;// Verification info (optional)
 String? get verifiedBy; String? get verifiedByName;@NullableTimestampConverter() DateTime? get verifiedAt; String? get verificationNotes;// Images (optional)
 String? get imageUrl; String? get completionImageUrl;// Details (optional)
 String? get description; bool get isUrgent;// Timestamps (optional)
@NullableTimestampConverter() DateTime? get assignedAt;@NullableTimestampConverter() DateTime? get startedAt;@NullableTimestampConverter() DateTime? get completedAt;// Department (optional)
 String? get departmentId;// Soft delete (optional)
@NullableTimestampConverter() DateTime? get deletedAt; String? get deletedBy;
