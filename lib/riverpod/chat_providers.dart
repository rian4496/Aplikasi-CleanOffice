// lib/riverpod/chat_providers.dart
...
/// Provider for conversations - uses StreamProvider for realtime updates
final conversationsStreamProvider = StreamProvider.autoDispose.family<List<Conversation>, String>(
  (ref, userId) {
...
/// Check if user is online - NOW USES REALTIME PRESENCE
final userOnlineStatusProvider = Provider.family<AsyncValue<bool>, String>(
  (ref, userId) {
    final onlineUsersAsync = ref.watch(onlineUsersStreamProvider);
    return onlineUsersAsync.whenData((onlineUsers) => onlineUsers.contains(userId));
  },
);
