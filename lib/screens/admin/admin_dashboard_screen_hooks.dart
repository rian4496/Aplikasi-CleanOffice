// lib/screens/admin/admin_dashboard_screen_hooks.dart
...
/// Admin Dashboard Screen - Multi-platform responsive dashboard
...
class AdminDashboardScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // ✅ HOOKS: Real-time service lifecycle (replaces initState + dispose)
    useEffect(() {
    ...
    return Scaffold(
      ...
      // ==================== APP BAR (Mobile Only) ====================
      appBar: !isDesktop ? _buildAppBar(context, ref, scaffoldKey) : null,

      // ==================== SIDEBAR (Desktop Only) ====================
      drawer: !isDesktop ? Drawer(child: _buildMobileDrawer(context, ref)) : null,
      endDrawer: !isDesktop ? Drawer(child: _buildMobileDrawer(context, ref)) : null,
  ...
  // ==================== APP BAR ====================
  AppBar _buildAppBar(BuildContext context, WidgetRef ref, GlobalKey<ScaffoldState> scaffoldKey) {
    final isDesktop = ResponsiveHelper.isDesktop(context);
