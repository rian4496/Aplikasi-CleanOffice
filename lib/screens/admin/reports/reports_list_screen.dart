// lib/screens/admin/reports/reports_list_screen.dart
// 📋 Reports List Screen
...
import '../../../widgets/admin/cards/mobile_report_card.dart';
import '../../../widgets/admin/actions/batch_action_bar.dart';
  ...
  List<Report> _filterReports(
    ...
    if (filter != 'all') {
      filtered = filtered.where((r) {
        final status = r.status.toLowerCase().replaceAll(' ', '');
