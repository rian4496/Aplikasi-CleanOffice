// lib/screens/employee/report_detail_employee_screen_hooks.dart
// ✅ MIGRATED TO HOOKS_RIVERPOD
//
// NOTES:
// - This is a pure display screen (no local state)
// - Changed from ConsumerWidget → HookConsumerWidget for consistency
// - All UI methods preserved as instance methods
// - Shows report timeline, completion photo, verification info
...
class ReportDetailEmployeeScreen extends HookConsumerWidget {
  final Report report;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (report.description != null) const SizedBox(height: 16),
