...
class InventoryAnalyticsScreen extends ConsumerWidget {
  ...
  Widget _buildStockStatusPieChart(List<InventoryItem> items) {
    final inStock = items.where((i) => i.status == StockStatus.inStock).length;
  ...
  Widget _buildCategoryBreakdownChart(List<InventoryItem> items) {
  ...
  Widget _buildStockLevelsBarChart(List<InventoryItem> items) {
  ...
  Widget _buildLowStockItemsList(List<InventoryItem> items) {
