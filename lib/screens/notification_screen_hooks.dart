// lib/screens/notification_screen_hooks.dart
...
import 'employee/report_detail_employee_screen.dart';
...
class NotificationScreen extends HookConsumerWidget {
  ...
  // ✅ STATIC HELPER: Handle notification tap
  static Future<void> _handleNotificationTap(
    ...
    if (notification.reportId != null) {
      ...
      try {
        ...
        final report =
            await employeeActions.getReportById(notification.reportId!);
  ...
  // ✅ STATIC HELPER: Handle dismiss
  static Future<void> _handleDismiss(
      WidgetRef ref, AppNotification notification) async {
