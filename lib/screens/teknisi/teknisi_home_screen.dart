...
import './teknisi_inbox_screen.dart';
...
class TeknisiHomeScreen extends ConsumerStatefulWidget {
  const TeknisiHomeScreen({super.key});

  @override
  ConsumerState<TeknisiHomeScreen> createState() => _TeknisiHomeScreenState();
}

class _TeknisiHomeScreenState extends ConsumerState<TeknisiHomeScreen> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      const TeknisiInboxScreen(), // Full screen widget
...
class _DashboardContent extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final ticketStatsAsync = ref.watch(teknisiTicketStatsProvider);
    final primaryBlue = const Color(0xFF3B82F6); 

    // Get stats with default fallback using when pattern
    final teknisiStats = ticketStatsAsync.when(
      data: (stats) => stats,
      loading: () => <String, int>{
        'assigned': 0,
        'inProgress': 0,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStatScroll(context, teknisiStats),
            ...
            Padding(
              ...
              child: _buildPerformanceCard(teknisiStats, primaryBlue),
            ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => context.push('/teknisi/my-tasks'),
                    child: Text(
                      'Lihat Semua',
             ...
             Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => context.push('/teknisi/schedule'),
                    child: Text(
                      'Lihat Semua',
                      style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w500, color: const Color(0xFF3B82F6)),
                    ),
              ...
              Column(
                ...
                children: [
                  ...
                  userProfileAsync.when(
                    ...
                    loading: () => Text('Udin...', style: GoogleFonts.inter(fontSize: 24, fontWeight: FontWeight.bold)),
                    error: (_,__) => Text('Teknisi', style: GoogleFonts.inter(fontSize: 24, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
              Row(
                children: [
                   IconButton(
                    ...
                    onPressed: () => context.push('/console/teknisi/notifications'), // Update route
                  ),
