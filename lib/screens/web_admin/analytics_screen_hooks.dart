// lib/screens/web_admin/analytics_screen_hooks.dart
...
class AnalyticsScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      // ==================== BODY ====================
      body: isDesktop
          ? _buildDesktopLayout(needsVerificationAsync)
          : _buildMobileLayout(needsVerificationAsync),
    );
  }
  ...
  /// Build app bar
  static AppBar _buildAppBar(BuildContext context, bool isDesktop) {
    return AppBar(
  ...
  static Widget _buildDesktopLayout(AsyncValue needsVerificationAsync) {
    return Row(
      children: [
        // Persistent Sidebar
  ...
  /// Build desktop header with search
  ...
  /// Build mobile layout
  static Widget _buildMobileLayout(AsyncValue needsVerificationAsync) {
  ...
  /// Build summary cards
  static Widget _buildSummaryCards(List<dynamic> reports) {
    // Calculate stats
